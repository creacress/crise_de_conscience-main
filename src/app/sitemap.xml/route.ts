...
const staticPaths = [
  ...
  '/s-informer',
  '/temoignages',
  '/temoins-de-jehovah/contre-articles',
  '/temoins-de-jehovah/contre-articles/questions-bibliques',
  '/temoins-de-jehovah/contre-articles/questions-bibliques/quelle-est-la-vraie-religion',
  '/temoins-de-jehovah',
  '/temoins-de-jehovah/divers/religion-est-elle-entreprise-commerciale',
  '/temoins-de-jehovah/divers',
